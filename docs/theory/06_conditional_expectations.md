...
3. **Key equations**
   ...
   $$\tilde{\mathbb{E}}_{n}[S_{n+1}]{}(\omega_1 \dots \omega_n) = \tilde{p} S_{n+1}(\omega_1    \dots \omega_n H) + \tilde{q} S_{n+1}(\omega_1 \dots \omega_n T) \quad \text{(2.3.4)}$$

   $$S_n = \frac{1}{1+r} \tilde{\mathbb{E}}_{n}[S_{n+1}] \quad \text{(2.3.5)}$$

   $$\mathbb{E}_{n}[X](\omega_1 \dots \omega_n) = \sum_{\omega_{n+1} \dots \omega_N} p^{\\#H(\omega_{n+1} \dots \omega_N)} q^{\\#T(\omega_{n+1} \dots \omega_N)} X(\omega_1 \dots \omega_n \omega_{n+1} \dots \omega_N) \quad \text{(2.3.6)}$$
