...
7. **Cross-references**
   ...
   * **Theorem 2.3.2 (Properties of Conditional Expectations):** Martingales are formulated on Theorem 2.3.2, specifically using:
     **(i) Linearity:** Essential for the proof of wealth pricing (Theorem 2.4.5) and Exercise 2.11(ii).
     **(ii) Taking out what is known & Independence (iv):** Used to compute the elementary and deeper proofs of Theorem 2.4.4.
     **(iii) Iterated Conditioning:** Required to propagate the martingale property over multiple steps (Remark 2.4.2).
